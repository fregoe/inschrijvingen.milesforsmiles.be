...
return [
    ...
    */
    ...
    'min' => [
        ...
        'string' => 'Het :attribute moet minimaal uit :min karakters bestaan.',
    ...
    'required' => 'Uw :attribute is verplicht in te vullen.',
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom ValidValidation Language Lines
    |--------------------------------------------------------------------------
    |
    ...
    */
    ...
    'custom' => [
        ...
        'password_confirmation' => [
            'confirmed' => 'De opgegeven wachtwoorden zijn niet gelijk.',
        ],
    ],
